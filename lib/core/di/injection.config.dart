...
import '../services/weight_service.dart' as _i363;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.singleton<_i363.WeightService>(() => _i363.WeightService());
    gh.lazySingleton<_i610.AudioRepository>(() => _i610.AudioRepository());
    gh.lazySingleton<_i662.FontService>(() => _i662.FontService());
    ...
    gh.lazySingleton<_i27.TtsService>(
        () => _i27.TtsService(gh<_i114.SettingsService>()));
